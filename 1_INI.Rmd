...
has.agendas.pesquisa <-
  evaluate::is.error(try(readxl::read_excel("PPG/Agendas de Pesquisa.xlsx", sheet = 1),
                silent = TRUE))
```

```{r try-apresentacao, results = "hide"}
has.apresentacao <-
  evaluate::is.error(try(readxl::read_excel("PPG/Apresentação.xlsx", sheet = 1),
                silent = TRUE))
```

```{r try-area-capes, results = "hide"}
has.area.capes <-
  evaluate::is.error(try(readxl::read_excel("PPG/Área CAPES.xlsx", sheet = 1),
                silent = TRUE))
```

```{r try-autoavaliacoes, results = "hide"}
has.autoavaliacao <-
  evaluate::is.error(try(readxl::read_excel("PPG/Autoavaliação.xlsx", sheet = 1),
                silent = TRUE))
```

```{r try-avaliacao, results = "hide"}
has.avaliacao <-
  evaluate::is.error(try(readxl::read_excel("PPG/Avaliação.xlsx", sheet = 1),
                silent = TRUE))
```

```{r try-bibliografia, results = "hide"}
has.bibliografia <-
  evaluate::is.error(try(readxl::read_excel("PPG/Bibliografia.xlsx", sheet = 1),
                silent = TRUE))
```

```{r try-blog-externos, results = "hide"}
has.blogs.externos <-
  evaluate::is.error(try(readxl::read_excel("PPG/Blogs externos.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.blog.ies <-
  evaluate::is.error(try(readxl::read_excel("PPG/Blog institucional.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.bolsas <-
  evaluate::is.error(try(readxl::read_excel("PPG/Bolsas.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.calendarios <-
  evaluate::is.error(try(readxl::read_excel("PPG/Calendários.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.cep <-
  evaluate::is.error(try(readxl::read_excel("PPG/Comitê de Ética em Pesquisa.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.convenios <-
  evaluate::is.error(try(readxl::read_excel("PPG/Convênios.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.cooperacoes <-
  evaluate::is.error(try(readxl::read_excel("PPG/Cooperações.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.coordenacao <-
  evaluate::is.error(try(readxl::read_excel("PPG/Coordenação.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.dados.cadastrais <-
  evaluate::is.error(try(readxl::read_excel("PPG/Dados Cadastrais.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.destaques <-
  evaluate::is.error(try(readxl::read_excel("PPG/Destaques.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.discentes <-
  evaluate::is.error(try(readxl::read_excel("PPG/Discentes.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.downloads <-
  evaluate::is.error(try(readxl::read_excel("PPG/Downloads.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.editais <-
  evaluate::is.error(try(readxl::read_excel("PPG/Editais.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.financiadores <-
  evaluate::is.error(try(readxl::read_excel("PPG/Financiadores.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.grupos.pesquisa <-
  evaluate::is.error(try(readxl::read_excel("PPG/Grupos de Pesquisa.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.historico <-
  evaluate::is.error(try(readxl::read_excel("PPG/Histórico.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.infraestrutura <-
  evaluate::is.error(try(readxl::read_excel("PPG/Infraestrutura.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.internacionalizacao <-
  evaluate::is.error(try(readxl::read_excel("PPG/Internacionalização.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.laboratorios <-
  evaluate::is.error(try(readxl::read_excel("PPG/Laboratórios.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.metodologia <-
  evaluate::is.error(try(readxl::read_excel("PPG/Metodologia.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.notas <-
  evaluate::is.error(try(readxl::read_excel("PPG/Notas.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.periodicos <-
  evaluate::is.error(try(readxl::read_excel("PPG/Periódicos institucionais.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.planejamento <-
  evaluate::is.error(try(readxl::read_excel("PPG/Planejamento estratégico.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.podcasts <-
  evaluate::is.error(try(readxl::read_excel("PPG/Podcasts.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.politicas <-
  evaluate::is.error(try(readxl::read_excel("PPG/Políticas.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.premio.capes <-
  evaluate::is.error(try(readxl::read_excel("PPG/Prêmio CAPES de Tese.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.premios <-
  evaluate::is.error(try(readxl::read_excel("PPG/Prêmios.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.producao <-
  evaluate::is.error(try(readxl::read_excel("PPG/Produção.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.repositorios.sede <-
  evaluate::is.error(try(readxl::read_excel("PPG/Repositórios.xlsx", sheet =  "Sede"),
                silent = TRUE)
  )
has.repositorios.cooperacao <-
  evaluate::is.error(try(readxl::read_excel("PPG/Repositórios.xlsx", sheet = "Cooperação"),
                silent = TRUE)
  )
```
...
has.videos <-
  evaluate::is.error(try(readxl::read_excel("PPG/Videos.xlsx", sheet = 1),
                silent = TRUE)
  )
```
...
has.artigos.completos.ppg <-
  evaluate::is.error(try(readxl::read_excel("PPG/Produção.xlsx", sheet = "PI.completos"),
                silent = TRUE))
...
has.artigos.resumos.ppg <-
  evaluate::is.error(try(readxl::read_excel("PPG/Produção.xlsx", sheet = "PI.resumos"), silent = TRUE))
...
has.preprints.ppg <-
  evaluate::is.error(try(readxl::read_excel("PPG/Produção.xlsx", sheet = "PI.preprints"),
                silent = TRUE))
...
has.livros.ppg <-
  evaluate::is.error(try(readxl::read_excel("PPG/Produção.xlsx", sheet = "PI.livros"), silent = TRUE))
if(!has.livros.ppg){
...
has.capitulos.ppg <-
  evaluate::is.error(try(readxl::read_excel("PPG/Produção.xlsx", sheet = "PI.capitulos"), silent = TRUE))
...
has.anais.ppg <-
  evaluate::is.error(try(readxl::read_excel("PPG/Produção.xlsx", sheet = "PI.anais"), silent = TRUE))
if(!has.anais.ppg){
