...
if(!sjmisc::is_empty(table.projetos)){
...
periodos <- names(sucupira.list)[na.omit(match(anos, names(sucupira.list)))]
...
cat("### **", as.character(j), "**", "\n", sep = "")
source("Scripts/table-with-buttons.R", local = knitr::knit_global())
create_dt(all_labs, title = "Programa - Laboratórios - Resumo")
cat('\n\n')
cat('**Fontes**: **PPG**')
cat('\n\n')
