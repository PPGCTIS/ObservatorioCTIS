...
if(nrow(dados_modelo) > 1) {
  ...
  tb_merged <-
    ...
    gtsummary::modify_header(
      label = "**Variável**",
      estimate_1 ~ "**Discentes (β)**",
      estimate_2 ~ "**Discentes (β)**",
      conf.low_1 ~ "**IC 95%**",
      conf.low_2 ~ "**IC 95%**"
    ) %>%
    ...
    gtsummary::modify_source_note(
      paste0(
        ...
        "<br>",
        "Modelo ajustado pelo número total de docentes como covariável.",
        "<br>",
        "Fonte: Plataforma Sucupira (https://sucupira.capes.gov.br)"
      )
    )
