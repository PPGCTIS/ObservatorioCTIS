...
mygraph <- igraph::graph_from_data_frame(edges1[, 1:2], vertices = vertices)
...
# Make the plot
ggraph::ggraph(mygraph, layout = "circlepack", weight = c(0, edges1[, 3])) +
  ggraph::geom_node_circle(ggplot2::aes(fill = as.factor(depth))) +
  ggplot2::scale_colour_brewer(RColorBrewer::brewer.pal(n = 9, name = "Set3")) +
  ggplot2::scale_fill_discrete(labels = c("Áreas de concentração", "Linhas de pesquisa")) +
  ggplot2::theme_void() +
  ggplot2::theme(
    ...
    legend.background = ggplot2::element_rect(fill = main.color,  color = main.color),
    legend.box.background = ggplot2::element_rect(fill = main.color,  color = main.color),
    legend.position = "top",
...
```{r sintese-coerencia-carousel, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", eval = has.sucupira.files}
cat('<br>')
cat('<br>')
...
bsplus::bs_carousel(id = "coerencia-carousel",
            ...
            use_controls = TRUE) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-coerencia-1.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-coerencia-2.png", width = "70%"))
...
```{r sintese-temas-carousel, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", eval = has.sucupira.files}
cat('<br>')
cat('<br>')
...
bsplus::bs_carousel(id = "temas-carousel",
            use_indicators = FALSE,
            use_controls = TRUE) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/Projetos.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/TCC.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/Produções.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/Produção bibliográfica.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/Produção técnica.png", width = "70%"))
...
```{r sintese-projetos-carousel, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", eval = has.sucupira.files}
cat('<br>')
cat('<br>')
...
bsplus::bs_carousel(id = "projetos-carousel",
            use_indicators = FALSE,
            use_controls = TRUE) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-projetos-1.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-projetos-2.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-projetos-3.png", width = "70%"))
...
```{r sintese-financiadores-carousel, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", eval = has.financiadores}
cat('<br>')
cat('<br>')
...
bsplus::bs_carousel(id = "financiadores-carousel",
  ...
  bsplus::bs_append(
    ...
    content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-financiadores-1.png", width = "70%")
  ) %>%
  bsplus::bs_append(
    id = "financiadores-carousel",
    content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-financiadores-2.png", width = "70%")
  ) %>%
  bsplus::bs_append(
    id = "financiadores-carousel",
    content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-financiadores-3.png", width = "70%")
  ) %>%
  bsplus::bs_append(
    id = "financiadores-carousel",
    content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-financiadores-4.png", width = "70%")
  ) %>%
  bsplus::bs_append(
    id = "financiadores-carousel",
    content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-financiadores-5.png", width = "70%")
  ) %>%
  bsplus::bs_append(
    id = "financiadores-carousel",
    content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-financiadores-6.png", width = "70%")
  )
...
barplot(table.2,
        ylab = "Estrato",
        col = rev(mycolors))
title(main = "Estrato da produção (Qualis)",
      outer = TRUE,
      cex.main = 1.7)
legend(
  "topleft",
...
vioplot::vioplot(as.numeric(table.3[, 2]) ~ as.numeric(table.3[, 1]),
        xlab = NA,
        ylab = "SJR")
title(main = "Métricas da produção (SJR)",
      outer = TRUE,
      cex.main = 1.7)
...
vioplot::vioplot(as.numeric(table.4[, 2]) ~ as.numeric(table.4[, 1]),
        xlab = NA,
        ylab = "CiteScore")
title(main = "Métricas da produção (CiteScore)",
      outer = TRUE,
      cex.main = 1.7)
...
# remove Indefinidos from plot
qualis.PPG.plot <- qualis.PPG[names(qualis.PPG) != "Indefinido"]
...
barplot(
  ...
  xlab = "%",
  ylab = "Estrato",
  xlim = c(0, max(qualis.PPG.plot)),
  ylim = c(0, length(unique(estratos.capes)) + 3),
  col = mycolors[2],
  cex.names = 0.7,
  xaxt = 'n',
  ann = FALSE
...
axis(1, at = round(c(
  0, max(qualis.PPG.plot)
)), labels = round(c(
  0, max(qualis.PPG.plot)
)))
title(
  main = "Métricas (Qualis, SJR, CiteScore)",
  outer = TRUE,
  cex.main = 1.7
)

# hist SJR PPG
SJR.PPG <- metricas_artigos$SJR[!is.na(metricas_artigos$SJR)]
...
# hist CiteScore PPG
CITESCORE.PPG <- metricas_artigos$CiteScore[!is.na(metricas_artigos$CiteScore)]
...
vioplot::vioplot(
  ...
  side = "both",
  ylim = c(min(
    as.numeric(CITESCORE.PPG), na.rm = TRUE
  ), max(
    as.numeric(CITESCORE.PPG), na.rm = TRUE
  )),
  ylab = "CiteScore",
...
```{r sintese-producao-carousel, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", eval = any(has.metricas.doi.ppg, has.metricas.doi.sucupira)}
cat('<br>')
cat('<br>')
...
bsplus::bs_carousel(id = "producao-carousel",
            use_indicators = FALSE,
            use_controls = TRUE) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-producao-1.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-producao-2.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-producao-3.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-producao-4.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-producao-5.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-producao-6.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-producao-7.png", width = "70%"))
...
```{r sintese-visibilidade-carousel, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", eval = any(has.metricas.doi.ppg, has.metricas.doi.sucupira)}
cat('<br>')
cat('<br>')
...
bsplus::bs_carousel(id = "visibilidade-carousel",
            use_indicators = FALSE,
            use_controls = TRUE) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-visibilidade-1.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-visibilidade-2.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-visibilidade-3.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-visibilidade-4.png", width = "70%"))
...
```{r sintese-pessoal-carousel, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", eval = has.discentes}
cat('<br>')
cat('<br>')
...
bsplus::bs_carousel(id = "pessoal-carousel",
            use_indicators = FALSE,
            use_controls = TRUE) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-pessoal-1.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-pessoal-2.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-pessoal-3.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-pessoal-4.png", width = "70%")) %>%
  bsplus::bs_append(content = bsplus::bs_carousel_image(src = "index_files/figure-html/sintese-pessoal-5.png", width = "70%"))
