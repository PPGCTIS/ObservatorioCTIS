...
# replace NA values by Indefinida
projetos.tipo$`Natureza do Projeto de Pesquisa`[is.na(projetos.tipo$`Natureza do Projeto de Pesquisa`)] <- "Indefinida"
...
# Reshape data for Plotly
table.1a <- as.data.frame(table.1)
names(table.1a) <- c("Nacionalidade", "Ano", "Frequência")

data_long <- dplyr::select(table.1a, `Nacionalidade`, `Ano`, `Frequência`)
