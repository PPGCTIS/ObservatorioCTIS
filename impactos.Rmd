...
síntese.ano <- dplyr::bind_cols(
      ...
      Qualis = factor(metricas_all_ID$Qualis),
...
if (dim(tcc)[1] != 0) {
  ...
  colnames(table.tcc) <-
    c("Ano", "Linha de Pesquisa", "Título", "Autor", "Orientador", "Financiador", "País")
} else {
...
table.tcc <- table.tcc[order(table.tcc$Ano, table.tcc$Título),]
