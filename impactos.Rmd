...
# Print HTML table
if (knitr::is_html_output() && !sjmisc::is_empty(turmas.curso)) {
...
# Print HTML table
if (knitr::is_html_output() && !sjmisc::is_empty(turmas.doc)) {
...
# Print HTML table
if (knitr::is_html_output() && length(table.3.1.2) > 0) {
...
# Print HTML table
if (knitr::is_html_output() && length(table.3.2.1) > 0) {
...
# Print HTML table
if (knitr::is_html_output() && length(table.1) > 0) {
  table.1 <- table.1 %>%
    gtsummary::as_gt() %>%
    gt::tab_style(
      style = gt::cell_borders(
...
# Print HTML table
if (knitr::is_html_output() && length(table.2) > 0) {
  table.2 <- table.2 %>%
    gtsummary::as_gt() %>%
    gt::tab_style(
      style = gt::cell_borders(
