...
# Print tables
table.continuada.gt <- gtsummary::tbl_summary(
...
síntese.ano <- dplyr::bind_cols(
      ...
      Qualis = as.character(metricas_all_ID$Qualis),
...
# dplyr::selecting those with COVID in the title
tcc <-
  tcc[grep(paste(tolower(pandemia), collapse = "|"),
...
# print table
source("Scripts/table-with-buttons.R", local = knitr::knit_global())
create_dt(table.tese, title = "Impactos - Ações durante a Pandemia - Teses")
...
# print table
source("Scripts/table-with-buttons.R", local = knitr::knit_global())
create_dt(table.tese, title = "Impactos - Ações durante a Pandemia - Dissertações")
