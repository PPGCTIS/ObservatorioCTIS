...
if (!sjmisc::is_empty(id.TCC)) {
  ...
  for (i in 1:length(id.TCC)) {
    ...
    bancas$Examinadores[i] <- if(is.na(banca$"Sigla da IES da Pessoa da Banca")) {
      paste0(unique(paste0(stringr::str_to_title(banca$"Nome da Pessoa da Banca"))), collapse = ", ")
      } else { paste0(unique(paste0(stringr::str_to_title(banca$"Nome da Pessoa da Banca"), " (", banca$"Sigla da IES da Pessoa da Banca", ")")), collapse = ", ")} 
