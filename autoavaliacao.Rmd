...
=======
>>>>>>> 99c674a8565023e9c6126e2301f97e5b80a6fbfd
# Print LaTeX table
if (knitr::is_latex_output()) {
  cat('\\FloatBarrier')
  # Convert gtsummary object to kableExtra object
...
sucupira.df.orient$"Nome do Orientador" <- factor(
  sucupira.df.orient$"Nome do Orientador",
  levels = sort(unique(c("Docentes", levels(sucupira.df.orient$"Nome do Orientador"), docentes.quadrienio)))
)
```
...
# check nlevels of Nível Discente
if (nlevels(sucupira.df.princ$`Nível Discente`) != 0) {
  if (nlevels(sucupira.df.princ$`Nível Discente`) == 1) {
    # Mestrado OU Doutorado
    # Print tables
    table.matr.gt <- sucupira.df.princ |>
>>>>>>> 99c674a8565023e9c6126e2301f97e5b80a6fbfd
...
<<<<<<< HEAD
    ...
    table.matr.gt <- sucupira.df.matr |>
=======
  } else if (nlevels(sucupira.df.princ$`Nível Discente`) == 2) {
    # Mestrado & Doutorado
    # Print tables
    table.matr.gt <- sucupira.df.princ |>
>>>>>>> 99c674a8565023e9c6126e2301f97e5b80a6fbfd
...
=======
  if (knitr::is_html_output() && !sjmisc::is_empty(sucupira.df.princ)) {
>>>>>>> 99c674a8565023e9c6126e2301f97e5b80a6fbfd
    print(table.matr.gt)
  }
...
=======
  if (knitr::is_latex_output() && !sjmisc::is_empty(sucupira.df.princ)) {
>>>>>>> 99c674a8565023e9c6126e2301f97e5b80a6fbfd
    cat('\\FloatBarrier')
    # Convert gtsummary object to kableExtra object
    kable_table <- gtsummary::as_kable_extra(
...
=======
      ) %>% kableExtra::column_spec(column = 1:(1 + length(unique(sucupira.df.princ$Anos)*nlevels(sucupira.df.princ$"Nível Discente"))), width = paste0(c(0.65, rep(0.20/(length(unique(sucupira.df.princ$Anos))), times = length(unique(sucupira.df.princ$Anos)*nlevels(sucupira.df.princ$"Nível Discente"))), 0.15)*(21-3-3), "cm"))
>>>>>>> 99c674a8565023e9c6126e2301f97e5b80a6fbfd
    print(kable_table)
  }
...
# filter sucupira.df.princ by "Situação Discente" == "Titulado"
...
if (nlevels(sucupira.df.princ$`Nível Discente`) != 0) {
  if (nlevels(sucupira.df.princ$`Nível Discente`) == 1) {
    # Mestrado OU Doutorado
    # Print tables
    table.tit.gt <- sucupira.df.princ |>
>>>>>>> 99c674a8565023e9c6126e2301f97e5b80a6fbfd
      dplyr::select('Anos', 'Nome do Orientador') |>
      gtsummary::tbl_summary(
        by = Anos,
