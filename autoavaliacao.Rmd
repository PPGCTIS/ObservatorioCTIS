...
names(table.ac.doc.long) <- c("Ano", "Docente")
...
table.ac.doc.long <- rbind(
  ...
  data.frame(
    ...
    "Docente" = rep("Áreas", times = length(unique(table.ac.doc$Docente))),
    check.names = FALSE
  )
)
...
# print tables
if (knitr::is_html_output() & has.dados.cadastrais) {
  # use kable for HTML output
  knitr::kable(
    area.ativas,
    align = "l",
...
} else if (!knitr::is_html_output() & has.dados.cadastrais) {
  # use tinytable for LaTeX output
...
names(table.lp.doc.long) <- c("Ano", "Docente")
...
table.lp.doc.long <- rbind(
  ...
  data.frame(
    ...
    "Docente" = rep("Linhas", times = length(unique(table.lp.doc$Docente))),
    check.names = FALSE
  )
)
...
```{r 1-1-2-disciplina-msc, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", eval = exists("table.msc")}
if(knitr::is_html_output() && !sjmisc::is_empty(table.msc)) {
...
} else if (knitr::is_latex_output() && !sjmisc::is_empty(table.msc)) {
  # use tinytable for LaTeX output
...
```{r 1-1-2-disciplinas-dsc, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", eval = exists("table.dsc")}
if(knitr::is_html_output() && !sjmisc::is_empty(table.dsc)) {
...
} else if (knitr::is_latex_output() && !sjmisc::is_empty(table.dsc)) {
  # use tinytable for LaTeX output
...
```{r 2-5-2-doc, eval = has.sucupira.files, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis"}
table.doc <-
  data.frame(matrix(
    NA,
...
```{r 2-5-2-docentes, eval = has.sucupira.files, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis"}
if(knitr::is_html_output()) {
...
if (knitr::is_latex_output()) {
  ...
  kable_table <- gtsummary::as_kable_extra(
    ...
    booktabs = TRUE,
    linesep = "",
    caption = ifelse(knitr::is_html_output(), "", "2.5.2 Docentes Responsáveis por Projetos"),
    bootstrap_options = c("basic", "hover", "condensed", "responsive"),
    latex_options = c("basic", "scale_down", "HOLD_position"),
    full_width = TRUE
  )
...
if (knitr::is_html_output()) {
  ...
  knitr::kable(
    ...
    format = "html",
    linesep = "",
    caption = "Docentes Responsáveis por Projetos"
  ) %>% kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = TRUE,
    position = "center"
  ...
  tinytable::tt(
    ...
    style = "bootstrap",
    align = "l",
    caption = ifelse(knitr::is_html_output(), "", "Docentes Responsáveis por Projetos")
  ) %>%
    tinytable::theme_tt("multipage", rowhead = 1, latex_float = "H")
    # Add LaTeX commands for new page and float barrier
    cat("\\newpage\n")
...
```{r 2-5-2-posdoc, eval = has.sucupira.files, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis"}
table.posdoc <-
  data.frame(matrix(
    NA,
...
```{r 2-5-2-posdoutorandos, eval = has.sucupira.files, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis"}
if(knitr::is_html_output()) {
...
if (knitr::is_latex_output()) {
  ...
  kable_table <- gtsummary::as_kable_extra(
    ...
    booktabs = TRUE,
    linesep = "",
    caption = ifelse(knitr::is_html_output(), "", "2.5.2 Pós-Docs Responsáveis por Projetos"),
    bootstrap_options = c("basic", "hover", "condensed", "responsive"),
    latex_options = c("basic", "scale_down", "HOLD_position"),
    full_width = TRUE
  )
