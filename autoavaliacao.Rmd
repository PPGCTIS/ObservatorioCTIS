...
```{r site-ppg, eval = all(render_document, exists("site.png")), echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = 'asis', fig.pos='H', out.width = "100%"}
# get URL
...
```{r observatorio-ppg, eval = all(render_document, exists("site.png")), echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = 'asis', fig.pos='H', out.width = "100%"}
# get URL
yml <- yaml::read_yaml("_site.yml")
URL.obs <- yml$href
