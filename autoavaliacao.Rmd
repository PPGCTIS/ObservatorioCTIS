...
```{r 1-1-2-disciplinas-msc, eval = has.sucupira.files, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis"}
if(knitr::is_html_output()) {
...
table.msc <- as.data.frame(table.msc, check.names = FALSE)

if(!sjmisc::is_empty(table.msc)) {
  ids <- order(table.msc[, 1], decreasing = FALSE)
  table.msc <- table.msc[ids,]
  # Print HTML table
  if (knitr::is_html_output()) {
    knitr::kable(
      table.msc,
      ...
      format = "html",
      linesep = "",
      caption = "1.1.2 Disciplinas do Mestrado"
    ) %>% kableExtra::kable_styling(
      bootstrap_options = c("striped", "hover", "condensed", "responsive"),
      full_width = TRUE,
      position = "center"
  ...
  if (knitr::is_latex_output()) {
    ...
    kable_table <- gtsummary::as_kable_extra(
      ...
      booktabs = TRUE,
      linesep = "",
      caption = ifelse(knitr::is_html_output(), "", "1.1.2 Disciplinas do Mestrado"),
      bootstrap_options = c("basic", "hover", "condensed", "responsive"),
      latex_options = c("basic", "scale_down", "HOLD_position"),
      full_width = TRUE
    )
...
```{r 1-1-2-disciplinas-dsc, eval = has.sucupira.files, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis"}
if(knitr::is_html_output()) {
...
table.dsc <- as.data.frame(table.dsc, check.names = FALSE)

if(!sjmisc::is_empty(table.dsc)) {
  ids <- order(table.dsc[, 1], decreasing = FALSE)
  table.dsc <- table.dsc[ids,]
  # Print HTML table
  if (knitr::is_html_output()) {
    knitr::kable(
      table.dsc,
      ...
      format = "html",
      linesep = "",
      caption = "1.1.2 Disciplinas do Doutorado"
    ) %>% kableExtra::kable_styling(
      bootstrap_options = c("striped", "hover", "condensed", "responsive"),
      full_width = TRUE,
      position = "center"
  ...
  if (knitr::is_latex_output()) {
    ...
    kable_table <- gtsummary::as_kable_extra(
      ...
      booktabs = TRUE,
      linesep = "",
      caption = ifelse(knitr::is_html_output(), "", "1.1.2 Disciplinas do Doutorado"),
      bootstrap_options = c("basic", "hover", "condensed", "responsive"),
      latex_options = c("basic", "scale_down", "HOLD_position"),
      full_width = TRUE
    )
