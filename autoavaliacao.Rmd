...
```{r 1-1-2-disciplina-msc, eval = exists("table.msc"), echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", fig.pos='H'}
if (all(knitr::is_html_output(), exists("table.msc"), try(!sjmisc::is_empty(table.msc), silent = TRUE))) {
...
if (all(knitr::is_html_output(), exists("table.msc"), try(!sjmisc::is_empty(table.msc), silent = TRUE))) {
  ...
  knitr::kable(
    ...
    full_width = TRUE,
    position = "center"
  ) %>% kableExtra::column_spec(column = 1:ncol(table.msc), width = paste0(c(0.64,0.12,0.12,0.12)*(21-3-3), "cm")) %>%
      kableExtra::column_spec(column = 1, bold = TRUE) %>%
      kableExtra::row_spec(row = 0, bold = TRUE)
} else {
  # use tinytable for LaTeX output
  ...
  tinytable::tt(
    table.msc,
    width = c(0.64,0.12,0.12,0.12)*(21-3-3),
    style = "bootstrap",
    align = "l",
...
```{r 1-1-2-disciplinas-dsc, eval = exists("table.dsc"), echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", fig.pos='H'}
if (all(knitr::is_html_output(), exists("table.dsc"), try(!sjmisc::is_empty(table.dsc), silent = TRUE))) {
...
if (all(knitr::is_html_output(), exists("table.dsc"), try(!sjmisc::is_empty(table.dsc), silent = TRUE))) {
  ...
  knitr::kable(
    ...
    full_width = TRUE,
    position = "center"
  ) %>% kableExtra::column_spec(column = 1:ncol(table.dsc), width = paste0(c(0.64,0.12,0.12,0.12)*(21-3-3), "cm")) %>%
      kableExtra::column_spec(column = 1, bold = TRUE) %>%
      kableExtra::row_spec(row = 0, bold = TRUE)
} else {
  # use tinytable for LaTeX output
...
if (knitr::is_latex_output()) {
  ...
  kable_table <- gtsummary::as_kable_extra(
    ...
    booktabs = TRUE,
    linesep = "",
    caption = ifelse(knitr::is_html_output(), "", "Dimensão do Corpo Docente")
  ) %>%
    kableExtra::kable_styling(
      bootstrap_options = c("basic", "hover", "condensed", "responsive"),
      latex_options = c("basic", "repeat_header", "HOLD_position"),
...
if (knitr::is_latex_output()) {
  ...
  kable_table <- gtsummary::as_kable_extra(
    ...
    booktabs = TRUE,
    linesep = "",
    caption = ifelse(knitr::is_html_output(), "", "Coerência Acadêmica do Corpo Docente à Proposta do Programa")
  ) %>%
    kableExtra::kable_styling(
      bootstrap_options = c("basic", "hover", "condensed", "responsive"),
      latex_options = c("basic", "repeat_header", "HOLD_position"),
