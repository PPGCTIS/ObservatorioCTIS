...
if (knitr::is_html_output() && !sjmisc::is_empty(summ.df)) {
  ...
  knitr::kable(
    ...
    kableExtra::footnote(
      ...
      general = c(
        "<a href='https://sucupira.capes.gov.br'>Plataforma Sucupira</a>"
      ),
      escape = FALSE)
  ...
  tinytable::tt(
    ...
    notes = list(
      "\\textbf{Fontes}: \\textbf{\\href{https://sucupira.capes.gov.br}{Plataforma Sucupira}}"
    )
  ) %>%
...
if (knitr::is_html_output() && !sjmisc::is_empty(table.1.1.1.ac)) {
  table.1.1.1.ac <- table.1.1.1.ac %>%
    gtsummary::modify_source_note("<a href='https://sucupira.capes.gov.br'>Plataforma Sucupira</a>")
...
if (!sjmisc::is_empty(lista.AC.LP)) {
  for (i in 1:length(lista.AC.LP)) {
    ...
    knit_expanded.1 <- paste0(
      ...
      "    kableExtra::footnote(\n\n",
      "       general_title = '<strong>Fontes</strong>: ',\n\n",
      "       general = c('<a href=\"https://sucupira.capes.gov.br\">Plataforma Sucupira</a>'),\n\n",
      "       escape = FALSE)\n\n",
      "} else {\n\n",
      "  # use tinytable for LaTeX output\n\n",
...
```{r 2-1-2-qualis, eval = all(render_document, any(has.sucupira.files)), echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = 'asis', fig.pos='H'}
...
if (knitr::is_html_output() && !sjmisc::is_empty(síntese.ano)) {
  table.3.2.1 <- table.3.2.1 %>%
    ...
    gtsummary::modify_source_note("<a href='https://sucupira.capes.gov.brpublic/consultas/coleta/veiculoPublicacaoQualis/listaConsultaGeralPeriodicos.jsf'>Qualis</a>") %>%
...
if (knitr::is_latex_output() && !sjmisc::is_empty(síntese.ano)) {
  ...
  kable_table <- gtsummary::as_kable_extra(
    ...
    kableExtra::footnote(
      general_title = "",
      general = c(
        "\\\\textbf{\\\\href{https://sucupira.capes.gov.br}{Plataforma Sucupira}}",
        ...
        "\\\\textbf{\\\\href{https://sucupira.capes.gov.brpublic/consultas/coleta/veiculoPublicacaoQualis/listaConsultaGeralPeriodicos.jsf}{Qualis}}",
...
make_fontes_note <- function() {
  if (knitr::is_html_output()) {
    return("<strong>Fontes:</strong> <a href='https://sucupira.capes.gov.br'>Plataforma Sucupira</a>, <a href='https://www.altmetric.com/'>Altmetric</a>")
  }
  if (knitr::is_latex_output()) {
    return("\\textbf{Fontes}: \\href{https://sucupira.capes.gov.br}{Plataforma Sucupira}, \\href{https://www.altmetric.com/}{Altmetric}")
  }
}
```
...
if (knitr::is_html_output() && !sjmisc::is_empty(externos)) {
  ...
  tinytable::tt(
    externos,
    width = c(0.30,0.20,0.40,0.10)*(29-3-3),
    align = "l",
...
if (knitr::is_html_output() && !sjmisc::is_empty(table.posdoc.hist)) {
  ...
  tinytable::tt(
    table.posdoc.hist,
    width = c(0.25,0.35,0.15,0.15,0.10)*(29-3-3),
    align = "l",
...
if (knitr::is_html_output() && !sjmisc::is_empty(editor.name.all)) {
  ...
  tinytable::tt(
    editor.name.all,
    width = c(0.10,0.10,0.25,0.30,0.15,0.10)*(29-3-3),
    align = "l",
...
if (knitr::is_html_output() && !sjmisc::is_empty(peer.review.all)) {
  ...
  tinytable::tt(
    peer.review.all,
    width = c(0.05,0.05,0.25,0.25,0.10,0.10,0.10,0.10)*(29-3-3),
    align = "l",
...
if (knitr::is_html_output() && !sjmisc::is_empty(member.all)) {
  ...
  tinytable::tt(
    member.all,
    width = c(0.10,0.10,0.30,0.30,0.10,0.10)*(29-3-3),
    align = "l",
...
if (knitr::is_html_output() && !sjmisc::is_empty(internacional)) {
  ...
  tinytable::tt(
    internacional,
    width = c(0.10,0.50,0.10,0.30)*(29-3-3),
    align = "l",
