...
options(knitr.kable.NA = '')
print(
  knitr::kable(table.pp.nt, align = c("l", rep("c", ncol(table.pp.nt) - 2), "r"), escape = FALSE, format = ifelse(knitr::is_html_output(), "html", "latex")) %>%
  kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = T,
    position = "center"
...
options(knitr.kable.NA = '')
print(
  knitr::kable(table.projetos.doc, align = c("l", rep("c", ncol(table.projetos.doc) - 2), "r"), escape = FALSE, format = ifelse(knitr::is_html_output(), "html", "latex")) %>%
  kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = T,
    position = "center"
...
options(knitr.kable.NA = '')
print(
  knitr::kable(table.projetos.posdoc, align = c("l", rep("c", ncol(table.projetos.posdoc) - 2), "r"), escape = FALSE, format = ifelse(knitr::is_html_output(), "html", "latex")) %>%
  kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = T,
    position = "center"
...
table.continuada.part <- table.continuada.part %>%
  dplyr::filter(Ano == quadrienal.vigente)

# select Formação with " - " in Formação
table.continuada.part <- table.continuada.part %>%
  dplyr::filter(grepl(" - ", Formação))
