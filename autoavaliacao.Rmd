...
table.curricular <- table.msc[ids,]
...
if (knitr::is_html_output()) {
  ...
  knitr::kable(
    ...
    format = "html",
    linesep = "",
    caption = "1.1.2 Estrutura curricular (Mestrado)"
  ) %>% kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = TRUE,
    position = "center"
  ...
  tinytable::tt(
    ...
    style = "bootstrap",
    align = "l",
    caption = ifelse(knitr::is_html_output(), "", "1.1.2 Estrutura curricular (Mestrado)")
  ) %>%
    tinytable::theme_tt("multipage", rowhead = 1, latex_float = "H")
    # Add LaTeX commands for new page and float barrier
    cat("\\newpage\n")
...
table.curricular <- table.dsc[ids,]
...
if (knitr::is_html_output()) {
  ...
  knitr::kable(
    ...
    format = "html",
    linesep = "",
    caption = "1.1.2 Estrutura curricular (Doutorado)"
  ) %>% kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = TRUE,
    position = "center"
  ...
  tinytable::tt(
    ...
    style = "bootstrap",
    align = "l",
    caption = ifelse(knitr::is_html_output(), "", "1.1.2 Estrutura curricular (Doutorado)")
  ) %>%
    tinytable::theme_tt("multipage", rowhead = 1, latex_float = "H")
    # Add LaTeX commands for new page and float barrier
    cat("\\newpage\n")
